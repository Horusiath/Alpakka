...
namespace Akka.Streams.Kafka
{
    ...
    /// <summary>
    /// Output element of <see cref="KafkaProducer.Committable{TKey,TValue}"/>.
    ...
    public sealed class CommittableMessage<TKey, TValue>
    {
        ...
        public Message<TKey, TValue> Record;

        public CommittableMessage(ICommittableOffset offset, Message<TKey, TValue> record)
        {
            Offset = offset;
            Record = record;
        }
